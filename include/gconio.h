...
/**** GLOBAL VARIABLES *********************/
#ifdef __linux__
static int __gconio_h_ansi_attr = 0;
static int __gconio_h_ansi_fg = 37;
static int __gconio_h_ansi_bg = 40;
#endif
#ifdef _WIN32
enum COLORS {
  BLACK = 0,
...
static WORD __gconio_h_ansi_fg = WHITE;
static WORD __gconio_h_ansi_bg = BLACK << 4;
#endif
...
inline void textcolor(int newcolor) {
#ifdef __linux__
  if (newcolor > 7) {
  ...
  printf("\033[%d;%d;%dm", __gconio_h_ansi_attr, __gconio_h_ansi_fg,
         __gconio_h_ansi_bg);
#endif
#ifdef _WIN32
  __gconio_h_ansi_fg = newcolor;
  SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),
                          (WORD)(__gconio_h_ansi_fg | __gconio_h_ansi_bg));
#endif
}

inline void textbackground(int newcolor) {
#ifdef __linux__
  switch (newcolor) {
  case 0:
